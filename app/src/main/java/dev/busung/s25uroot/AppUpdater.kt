...
const val ROOT_MY_GALAXY_URL = "https://github.com/BuSung-dev/Root-My-Galaxy-Payloads"

object AppUpdater {

    private const val GITHUB_API = "https://api.github.com/repos/BuSung-dev/Root-My-Galaxy-Payloads"
    private const val RELEASES_PAGE = "$ROOT_MY_GALAXY_URL/releases/latest"

    suspend fun fetchLatestRelease(): UpdateInfo? = null

    @Suppress("unused")
    private suspend fun fetchLatestReleaseNetwork(): UpdateInfo? = withContext(Dispatchers.IO) {
        try {
