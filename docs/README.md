...
Detailed notes for the offline Galaxy S24 Ultra DZF2 pack.

## Pages

- [Target Profile](TARGET.md): exact SM-S928U/U1 and SM-S928B DZF2 values.
- [Project Structure](PROJECT_STRUCTURE.md): repository layout and important files.
- [Reproduce The Port](REPRODUCE_PORT.md): payload rebuild and local asset checks.
